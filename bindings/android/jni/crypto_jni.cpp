...
Java_com_crypto_lib_CryptoLib_aesGCMEncrypt(JNIEnv *env, jobject thiz, jbyteArray key, jbyteArray plaintext) {
    ...
    jmethodID constructor = env->GetMethodID(encryptedDataClass, "<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V");
    if (constructor == NULL) {
    ...
    jstring tag = env->NewStringUTF(cResult->tag);
    
    jobject result = env->NewObject(encryptedDataClass, constructor, ciphertext, nonce, tag);
...
Java_com_crypto_lib_CryptoLib_aesGCMDecrypt(JNIEnv *env, jobject thiz, jbyteArray key, jobject encryptedData) {
    ...
    jfieldID tagField = env->GetFieldID(encryptedDataClass, "tag", "Ljava/lang/String;");
